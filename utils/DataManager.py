...
class DataManager:
    ...
    def get_lr_images(self, data_points, n_revisits=1, image_shape=(3, 157, 159)):
    ...
    def transform_to_rgb(self, sat_image):
        ...
        blue_band = sat_image[0][:, :, 0]
        green_band = sat_image[0][:, :, 1]
        red_band = sat_image[0][:, :, 2]
    ...
    def read_sat_images(self, folder, image_shape=(3, 157, 159), n_revisits=1):
